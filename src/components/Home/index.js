...
const Home = () => {
    ...
    const nameArray = ['M', 'a', 'r', 't', 'i', 'n', 'e', 'z']
        ...
        <>
            <div className = "container home-page" >
                <div className = "text-zone" >
                    ...
                    <span className = { `${letterClass} _20` } > x < /span> 
                    ...
                    /> 
                < /h1 > 
                <h2 > Frontend Developer / JavaScript Expert / Instagrammer < /h2> 
                <Link to = "/contact"
                className = "flat-buttom" >
                CONTACT ME 
                </Link> 
                < /div > 
                <Logo / >
    ...
    <>
      <div className="container home-page">
        <div className="text-zone">
          ...
          <h2>Front End Developer / JavaScript / Youtuber / Marketing </h2>
